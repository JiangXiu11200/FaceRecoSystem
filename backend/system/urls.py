...
from .views import UserRecognitionConfigPreviewViewSet, UserRecognitionConfigViewSet, UserRecognitionDebugViewSet
...
user_recognition_router.register(
    r"api/face-recognition-config/preview", UserRecognitionConfigPreviewViewSet, basename="user-recognition-preview"
)
user_recognition_router.register(
