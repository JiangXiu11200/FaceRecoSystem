...
def generate_access_jwt(
    user_id: int, account: str, permissions: list, exp_delta_seconds: int = 3600
) -> Union[str, None]:
...
def generate_refresh_jwt(user_id: int, account: str, permissions: list, exp_delta_days: int = 3) -> Union[str, None]:
