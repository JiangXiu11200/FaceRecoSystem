...
function AlarmLogs() {
    ...
    const [search_content, setSearchContent] = useState(cloneDeep(empty_search_content))
    ...
    const doConfirm = () => {
        toast.current.show({ severity: "success", summary: "Success", detail: "Alarm confirmed successfully", life: 3000 })
            ...
            <div className="row g-2">
                <div className="col-4">
                    ...
                    <div className="field-group">
                        <MultiSelect className="w-100" placeholder="Alarm Category" options={[]} onChange={() => {}} optionLabel="name" />
                    </div>
                </div>
                <div className="col-4">
                ...
                <div className="col-4">
                    ...
                    <Calendar
                        ...
                        minDate={search_content.start_date ? search_content.start_date : null}
        ...
        <React.Fragment>
            <div className="d-flex justify-content-end">
                <div className="d-flex">
                    <div className="me-2">
                        <Button label="Confirm" icon="pi pi-check" className="p-button-text func-btn" onClick={doConfirm} />
                    </div>
                    <div>
                        <Button label="Cancel" icon="pi pi-times" className="p-button-text cancel-btn" onClick={hideConfirmAlarmDialog} />
                    </div>
                </div>
            </div>
        </React.Fragment>
    ...
    return (
        <div className="d-flex flex-column">
            ...
            <Table data={table_data} columns={columns} actnioEvent={setActionEvent} imageFlag={true} />
            <Dialog
