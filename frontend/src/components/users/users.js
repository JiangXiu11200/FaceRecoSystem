...
function Users() {
        ...
        <React.Fragment>
            <div className="d-flex justify-content-between">
                <div className="d-flex">
                    <Button label="Delete" icon="pi pi-times" className="p-button-text delete-btn" onClick={showDeleteUserDialog} />
                </div>
                <div className="d-flex">
                    <div className="me-2">
                        <Button label="Save" icon="pi pi-check" className="p-button-text func-btn" onClick={doSaveUser} />
                    </div>
                    <div>
                        <Button label="Cancel" icon="pi pi-times" className="p-button-text cancel-btn" onClick={hideEditUserDialog} />
                    </div>
                </div>
            </div>
        </React.Fragment>
    ...
    const deleteUserDialogFooter = (
        <React.Fragment>
            <div className="d-flex flex-row justify-content-end">
                <div className="me-2">
                    <Button label="Cancel" icon="pi pi-times" className="p-button-text cancel-btn" onClick={hideUserDetailDialog} />
                </div>
                <div>
                    <Button label="Sure" icon="pi pi-times" className="p-button-text delete-btn" onClick={doDeleteUser} />
                </div>
            </div>
        </React.Fragment>
    )
    ...
    return (
        <div className="d-flex flex-column">
            ...
            <Dialog visible={set_edit_user} className="" header="Edit User" footer={editUserDialogFooter} onHide={hideEditUserDialog}>
                <div className="edit-user-dialog">
                    <div className="right-content">
                        ...
                        <div>
                            ...
                            <InputText className="p-inputtext" placeholder="" disabled={true} />
                        </div>
                    </div>
            ...
            <Dialog visible={set_delete_dialog} className="" header="Delete Group" footer={deleteUserDialogFooter} onHide={hideUserDetailDialog}>
